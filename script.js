...
function addmeal(mealData, random = false) {
  ...
  randomRecipe.innerHTML = `
        ...
        <div class="meal-info">
          ...
          <button class="add-to-fav-btn ${mealIds.includes(mealId) ? 'active' : ''}" title="delete"><i class="fa-solid fa-heart"></i></button>
        </div>
      </div>
  `;
...
function addMealFav(mealData) {
  ...
  meal.innerHTML = `
    <div class="meal-pic">
      ...
      <button class="del-logo"><i class="fa-solid fa-trash"></i></button>
    </div>
